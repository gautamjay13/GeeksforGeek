<h2><a href="https://www.geeksforgeeks.org/problems/reverse-coding2452/1?page=3&difficulty=Basic,Easy&sortBy=submissions">Sum of Natural Numbers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given an integer <strong>n</strong>, compute the sum of all natural numbers from 1 to n (inclusive). If n is 0, the sum should be 0.</span></p>
