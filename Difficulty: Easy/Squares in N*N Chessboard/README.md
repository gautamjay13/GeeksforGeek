<h2><a href="https://www.geeksforgeeks.org/problems/squares-in-nn-chessboard1801/1?sortBy=submissions&category%5B%5D=Numbers&page=1&difficulty%5B%5D=-1">Squares in N*N Chessboard</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Find the total number of Squares in a <strong>N*N</strong> chessboard.</span></p>
<p>&nbsp;</p>
